...
if __name__ == '__main__':
    ...
    if args.optimizer == 'sgd':
    ...
    elif args.optimizer == 'adamod':
        print("using AdaMod!")
        optimizer = adamod.AdaMod(net.parameters(), lr=args.lr)
        ...
        print("using AdamP!")
        optimizer = AdamP(net.parameters(), lr=args.lr)
        ...
        print("using nero!")
        optimizer = Nero(net.parameters(),lr=args.lr,beta=args.beta,constraints=True)
